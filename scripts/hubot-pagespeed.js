...
//
// Commands:
//   hubot pagespeed <url> (desktop|mobile) (all|score|stats) - Get PageSpeed results for <url>
//
// Author:
//   federicot
...
(function() {
    ...
    module.exports = function(robot) {
        robot.respond(/pagespeed ([^\s]*)\s?(desktop|mobile)?\s?(all|score|stats)?/i, function(msg) {
            ...
            var scope = (typeof(msg.match[3]) == 'undefined') ? 'score' : msg.match[3];
            var options = {
                //key: '',
                url: url,
                paths: '', // optional
